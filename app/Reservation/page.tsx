...
import RedervationTableOprations from '@/components/Reservations/RedervationTableOprations/RedervationTableOprations'
        ...
        <div className='flex w-full'>
            <div>
                <div style={{ width: "200px", minHeight: "100vh", background: "#F8F9FA" }} >
                        ...
                        <div className='flex flex-col gap-1 text-gray-500'>
                            {GruopByArra.map((item, index) => (
                                <div
                                    ...
                                    className={`cursor-pointer ${selectedMenuItem === item ? 'bg-gray-300 text-black ' : ''}`}
                    ...
                    <div className='flex flex-col gap-1 '>
                        <p className=' p-3 font-Lato text-black font-semibold'>Availability</p>
                        <div className='flex flex-col gap-1 text-gray-500'>
            ...
            <div className='w-full'>
                ...
                {selectedMenuItem === 'Reservation Status' && <GroupByReservationStatus />}
